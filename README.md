...
|:white_large_square: [#12327](https://github.com/docker/docker/issues/12327)|pip fails|:scream: High|:smiley: Easy|Overlay Bug|None (Workaround 1: [`--ignore-installed`](https://github.com/docker/docker/issues/12327#issuecomment-187158265), Workaround 2: [patch](https://bugzilla.kernel.org/show_bug.cgi?id=109611))||
